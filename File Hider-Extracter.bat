...
:Path1
echo.
set /p FullPath="What is the full path to your folder that contains the files? "
if not exist "%FullPath%" goto NotExistPath1
cd %FullPath%
goto Hide
...
if not exist "%FullPath%\%Hide1%" goto NotHide1
echo.
set /p Hide2="Which file do you want to hide %Hide1% in? "
if not exist "%FullPath%\%Hide2%" goto NotHide2
echo.
...
:NotHide1
echo "%FullPath%\%Hide1%" does not exist!
goto 1

:NotHide2
echo "%FullPath%\%Hide2%" does not exist!
goto 1
...
echo.
set /p FullPath="What is the full path to your folder that contains the files? "
if not exist "%FullPath%" goto NotExistPath2
cd %FullPath%
goto Show
...
if not exist "%FullPath%\%Show1%" goto NotShow1
echo.
...
:NotShow1
echo "%FullPath%\%Show1%" does not exist!
goto 2
